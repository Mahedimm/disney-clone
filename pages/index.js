...
import MovesCollection from '../components/MovesCollection/MovesCollection';
import ShowsCollection from '../components/ShowsCollection/ShowsCollection';
    ...
    <div className="">
      ...
      {!session ? <Hero /> :(
        <main className="relative min-h-screen after:bg-home after:bg-center after:bg-cover after:bg-no-repeat after:bg-fixed after:absolute after:inset-0 after:z-[-1]">
          <Slider />
          <Brands />
          <MovesCollection results={popularMovies} title="Popular Movies" />
          <MovesCollection results={top_ratedMovies} title="Top Rated Movies" />
